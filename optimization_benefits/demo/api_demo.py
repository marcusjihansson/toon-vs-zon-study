#!/usr/bin/env python3
"""
api_demo.py - Demo of API Benchmark with Mock Data

This demo script shows how the API benchmark works using mock metrics instead
of real LLM calls. Perfect for testing and demonstrations without API costs.

Usage:
    python cli/execution/api_demo.py
"""
...
def run_demo_benchmark(queries: List[str]) -> Dict[str, Any]:
    ...
    """
    print("\n" + "=" * 70)
    print("DEMO: SHOPIFY API RAG BENCHMARK (MOCK DATA)")
    print("=" * 70)
